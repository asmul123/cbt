                                            ...
                                            <div class="row justify-content-end">
                                                    <div class="col-md-9 col-9">
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            ...
                                                            <a href="{{ url('penjadwalan/create/?act=release&id_tugas='.$penjadwalan->id) }}" class="btn btn-sm btn-warning">
                                                                <i data-feather="refresh-cw"></i>
                                                            </a>
                                                            <a href="{{ url('penjadwalan/create/?act=hapus&id_tugas='.$penjadwalan->id) }}" class="btn btn-sm btn-danger">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group mb-3" role="group" aria-label="Basic example">
                                                        ...
                                                        if($pengerjaan){
                                                        @endphp
                                                        <a href="{{ url('/') }}/penjadwalan/create?act=detail&pengerjaan_id={{ $pengerjaan->id }}" class="badge icon bg-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat Pekerjaan Siswa"><i data-feather="list"></i></a>
                                                        <a href="{{ url('/') }}/penjadwalan/create?act=reset&pengerjaan_id={{ $pengerjaan->id }}" class="badge icon bg-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Atur Ulang/Hapus Pekerjaan Siswa" onclick="return confirm('Yakin akan menghapus pekerjaan siswa ini?')"><i data-feather="rotate-ccw"></i></a>
                                                        <a href="{{ url('/') }}/penjadwalan/create?act=selesai&pengerjaan_id={{ $pengerjaan->id }}" class="badge icon bg-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Submit Pekerjaan Siswa"><i data-feather="check-square"></i></a>
                                                        @php
                                                        ...
                                                        @endphp
                                                        <a href="{{ url('/') }}/penjadwalan/create?act=blokir&pengerjaan_id={{ $pengerjaan->id }}" class="badge icon bg-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Blokir Siswa"><i data-feather="slash"></i></a>
                                                        @php
                                                            }
                                                        @endphp
                                                        <script>
